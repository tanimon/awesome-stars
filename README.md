...
- [karen-irc/option-t](https://github.com/karen-irc/option-t) - Option/Result type implementation in ECMAScript whose APIs are inspired by Rust's `Option&lt;T&gt;` and `Result&lt;T, E&gt;`.
